      ...
      <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
        <ReactMarkdown
          ...
          components={{
            ...
            h5({ children }) {
              return (
                <h5 className="text-sm font-bold mt-3 mb-2">{children}</h5>
              );
            },
            h6({ children }) {
              return (
                <h6 className="text-xs font-semibold mt-2 mb-2">{children}</h6>
              );
            },
            a({ children, href }) {
              return (
    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        >
          ...
          {copied && (
            <span className="absolute -top-8 right-0 bg-black text-white text-xs rounded-md px-2 py-1 opacity-80 group-hover:opacity-100 transition-all duration-300">
              Copied!
            </span>
          )}
        </button>
